...
### 🧭 Right Now
- 🚀 Building **JOJO Digital** — web design, AI development, Canva design, video editing & prompt engineering for local businesses in Hosur.
- 🎓 BCA 2nd Year student, M.G.R. College, Hosur (Periyar University, Salem).
- 🏅 NSS Programme Officer.
- 🛠️ Building **STARK CONTROL** — mobile-controlled laptop system (Flask + React Native Expo + ngrok).
- 💼 Freelancing on Fiverr (`srikumarm161`).
